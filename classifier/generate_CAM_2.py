...
if __name__ == "__main__":
    model = load_model("./models/whole_body_resnet101/unfreezed-model-0.89-405_FINAL.h5")

    test_img = img_to_array(load_img("/data/bhuiyan/bee/rusty/classifier/dataset/whole_body/test/non_rusty/Andrena_cineraria_10_90.jpeg" , target_size=(512,512)))
